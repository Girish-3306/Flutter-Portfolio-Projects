...
class _BodyState extends State<Body> {
  ...
  Future<void> checkoutButtonCallback() async {
    ...
    final confirmation = await showConfirmationDialog(
      context,
      "This is just a Offer Testing App so, no actual Offers Interface is available.\nDo you want to proceed for Mock Offers on Products?",
    );
      ...
      if (orderedProductsUid != null) {
        ...
        try {
          ...
          if (addedProductsToMyProducts) {
            snackbarmMessage = "Offers applied Successfully";
          } else {
      ...
      await showDialog(
        ...
        builder: (context) {
          return FutureProgressDialog(
            orderFuture,
            message: Text("Placing the Offers"),
          );
        },
      );
    }).catchError((e) {
